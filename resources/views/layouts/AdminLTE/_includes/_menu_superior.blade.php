<header class="main-header">
  ...
  <nav class="navbar navbar-static-top">
    ...
    <div class="navbar-custom-menu">
      ...
      <span class="logo-lg">@php print_r(App::getLocale()); @endphp {{__('messages.xyz')}}</span>
      <ul class="nav navbar-nav">
        <li><a href="{{ url('admin/lang/en') }}">English</a></li>
        <li><a href="{{ url('admin/lang/pt_BR') }}">Español</a></li>
      </ul>
      <ul class="nav navbar-nav">          
